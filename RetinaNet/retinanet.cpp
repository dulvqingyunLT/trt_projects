    ...
    SampleUniquePtr<nvinfer1::IBuilderConfig>& config)
{
    ...
    profile->setDimensions(input->getName(), OptProfileSelector::kMIN, Dims4(1,3,384,384));

    profile->setDimensions(input->getName(), OptProfileSelector::kOPT, Dims4(8,3,384,384));

    profile->setDimensions(input->getName(), OptProfileSelector::kMAX, Dims4(16,3,384,384));
