...
#ifndef TRT_DELTA_2_BBOX_PLUGIN_H
#define TRT_DELTA_2_BBOX_PLUGIN_H
...
class DynamicDelta2Bbox : public IPluginV2DynamicExt
{
public:
    DynamicDelta2Bbox(int h, int w);
...
class DynamicDelta2BboxPluginCreator : public BaseCreator
{
public:
...
#endif // TRT_DELTA_2_BBOX_PLUGIN_H
